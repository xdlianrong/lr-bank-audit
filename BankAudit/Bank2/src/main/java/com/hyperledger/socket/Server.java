        ...
        while (true){
            try {
                ...
                if (str1.equals("1")){
                     ...
                     * 这里是进行初始化的flag
                     */
                    FileReader file = new FileReader("bank2AssetsRecord.txt");
                     ...
                     */
                    BigInteger assetsSum = ReadBigInteger.readBigInteger("bank2AssetsRecord.txt");
                    BigInteger newAssets = new BigInteger(str.substring(6, str.length()));
                    String str2 = str.substring(1,6);
                    FileWriter file1 = new FileWriter("bank2AssetsRecord.txt");
                    file1.write(assetsSum.add(newAssets)+"\n");
                    file1.close();
                    FileWriter file2 = new FileWriter("bank2AssetsRecord1.txt",true);
                    file2.write(str2+" -> "+"bank2:" + newAssets + "\n");
                    file2.close();
                    /**
                    ...
                    if (newAssets.compareTo(BigInteger.valueOf(0)) == 1){
                        ...
                        FileWriter file3 = new FileWriter("bank2TransactionTime.txt");
                        FileWriter file4 = new FileWriter("bank2DoubleComSum.txt");
                        FileWriter file5 = new FileWriter("bank2TripleComSum.txt");
                        FileWriter file6 = new FileWriter("bank2QuadraComSum.txt");

...
//                Selections.auditorSelect();
                ...
                AssetsReSet.assetsReset("bank2AssetsRecord.txt", "1000");
                AssetsReSet.assetsReset("bank2TransactionTime.txt", "0");
                AssetsReSet.assetsReset("bank2DoubleComSum.txt","0");
                AssetsReSet.assetsReset("bank2TripleComSum.txt","0");
                AssetsReSet.assetsReset("bank2QuadraComSum.txt","0");
                FlushFile.flushFile("bank2AssetsRecord1.txt");
                System.exit(0);
            } else {

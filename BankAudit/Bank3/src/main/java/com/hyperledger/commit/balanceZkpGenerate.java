...
//            System.out.println(m);
        ...
        //银行1的承诺
        BigInteger D1 = (a2.add(bank3r1.multiply(c1))).mod(arr[1]);
        //计算银行234的交易承诺的随机数和
        BigInteger r1_sum = bank1r1.add(bank2r1).add(bank4r1);
        ...
        //银行1的比特承诺
        BigInteger M1 = (a5.add(bank3r2.multiply(h1))).mod(arr[1]);
        //计算银行234的比特承诺的随机数和
        BigInteger r2_sum = bank1r2.add(bank2r2).add(bank4r2);
        ...
        if(bankStr.equals("bank1")){
            r3_sum = (bank1r1.multiply(s.add(BigInteger.valueOf(1))).add(bank2r1.multiply(s)).add(bank4r1.multiply(s))).mod(arr[1]);
        } else if (bankStr.equals("bank2")){
            r3_sum = (bank2r1.multiply(s.add(BigInteger.valueOf(1))).add(bank1r1.multiply(s)).add(bank4r1.multiply(s))).mod(arr[1]);
        }else {
            r3_sum = (bank4r1.multiply(s.add(BigInteger.valueOf(1))).add(bank2r1.multiply(s)).add(bank1r1.multiply(s))).mod(arr[1]);
        }

        BigInteger temp1 = m.multiply(s.add(BigInteger.valueOf(1)));    //bank1承诺的隐藏值，m(1+s)
        BigInteger temp2 = (bank3r1.multiply(s.add(BigInteger.valueOf(1))));    //随机数 bankr1(s+1)
         ...
         */
        BigInteger r2_allsum = r2_sum.add(bank3r2);

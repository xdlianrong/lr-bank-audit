...
//                Selections.auditorSelect();
                ...
                AssetsReSet.assetsReset("bank3AssetsRecord.txt", "1000");
                AssetsReSet.assetsReset("bank3TransactionTime.txt", "0");
                AssetsReSet.assetsReset("bank3DoubleComSum.txt","0");
                AssetsReSet.assetsReset("bank3TripleComSum.txt","0");
                AssetsReSet.assetsReset("bank3QuadraComSum.txt","0");
                FlushFile.flushFile("bank3AssetsRecord1.txt");
                System.exit(0);
            } else {

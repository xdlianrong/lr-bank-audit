        ...
        while (true){
            try {
                ...
                if (str1.equals("1")){
                     ...
                     * 这里是进行初始化的flag
                     */
                    FileReader file = new FileReader("bank4AssetsRecord.txt");
                     ...
                     */
                    BigInteger assetsSum = ReadBigInteger.readBigInteger("bank4AssetsRecord.txt");
                    BigInteger newAssets = new BigInteger(str.substring(6, str.length()));
                    String str2 = str.substring(1,6);
                    FileWriter file1 = new FileWriter("bank4AssetsRecord.txt");
                    file1.write(assetsSum.add(newAssets)+"\n");
                    file1.close();
                    FileWriter file2 = new FileWriter("bank4AssetsRecord1.txt",true);
                    file2.write(str2+" -> "+"bank4:" + newAssets + "\n");
                    file2.close();
                    /**
                    ...
                    if (newAssets.compareTo(BigInteger.valueOf(0)) == 1){
                        ...
                        FileWriter file3 = new FileWriter("bank4TransactionTime.txt");
                        FileWriter file4 = new FileWriter("bank4DoubleComSum.txt");
                        FileWriter file5 = new FileWriter("bank4TripleComSum.txt");
                        FileWriter file6 = new FileWriter("bank4QuadraComSum.txt");

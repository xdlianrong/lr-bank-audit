...
//                Selections.auditorSelect();
                ...
                AssetsReSet.assetsReset("bank4AssetsRecord.txt", "1000");
                AssetsReSet.assetsReset("bank4TransactionTime.txt", "0");
                AssetsReSet.assetsReset("bank4DoubleComSum.txt","0");
                AssetsReSet.assetsReset("bank4TripleComSum.txt","0");
                AssetsReSet.assetsReset("bank4QuadraComSum.txt","0");
                FlushFile.flushFile("bank4AssetsRecord1.txt");
                System.exit(0);
            } else {
